...
**Global Hex Range:** `0x1B8000` - `0x1BBFFF`  
**Bank Type:** N/A  
**Category:** Free  
...
| :------------- | :-------------- | :----- | :---------- |
| `0x4000` | `0x1B8000` | 16KB | `0x00` padding (Safe Free Space) |
...
001B8010  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  ................
001B8020  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  ................
... 
001BBFF0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  ................
```
[⬅️ Back to Master ROM Map](../DWM_Master_ROM_Map.md)
---
